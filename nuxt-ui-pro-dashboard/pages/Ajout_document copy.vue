...
<template>
  ...
  <!-- component -->
    ...
    <div class="flex flex-row h-full">
      ...
      <div class="flex-none xl:w-1/3 lg:w-1/4  bg-[#027BCE] bg-opacity-10 h-screen p-20% ">
        <div class=" flex items-stretch	 flex-col h-full lg:space-y-4 md:space-y-2">
          ...
          <div class=" flex-5/6 relative lg:left-24 lg:top-12 md:top-6 md:left-6 w-3/4 grid grid-rows-auto   grid-flow-row gap-2 ">
           ...
           <button @click="refreshPage" type="button" class="relative top-1 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-base px-6 py-3 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Annuler</button>
            </div>
      ...
      <div class="flex-grow md:w-1/2  border border-green-600">
