<script lang="ts">
  ...
  export default {
    ...
    getDocument() {
      ...
      this.source=fileStore.getSource;
      console.log('source',this.source)
      if(this.source=='review'){
        this.isVerified=true;
        this.mongoDB='tbr';
      }else if(this.source=='recherche'){
...
<template>
  ...
  <div class="">
    ...
    <Popup
      ...
      :description1="'Votre Document'"
      :titreDoc="this.metadata.name"
      :description2="'a bien été supprimé.'"
      :color="true"
      :annuler="false">
    </Popup>
    ...
    <!-- component -->
      <div class="flex-col w-full  p-10% ">
         ...
         <div class="flex-none xl:w-1/3 lg:w-1/4 bg-[#027BCE] bg-opacity-10 h-full h-screen overflow-auto overflow-x-hidden">
           <div class=" flex items-stretch	 flex-col h-full lg:space-y-4 md:space-y-2">
             ...
             <div class=" flex-5/6 relative lg:left-24 lg:top-12 md:top-6 md:left-6 w-3/4 grid grid-rows-auto justify-left items-left  grid-flow-row gap-1 ">
               ...
               <div class=" w-full  flex justify-items-start items-start">
               <description titre="Retranscription" class="w-full min-h-80 " :content="this.metadata.retranscription" :dateModif="this.dateModif" :isVisible=true :ajoutePar="this.metadata.creator" ref="retranscription" />
        ...
        <div class=" flex-col h-screen p-10% flex-grow md:w-1/2 space-y-3 ">
                ...
                <div class="flex-row place-content-between flex  mx-auto">

                    <div class=" place-content-center items-center flex ml-2 w-2/5 ">
                    ...
                    <div class="place-content-center items-center	flex w-2/5 " v-show="isVerified">
                    ...
                    <div class=" place-content-end items-end flex w-2/5 ">
                      <button @click="deleteDocument()" type="button" class="relative top-1 text-white bg-red-500 hover:bg-red-600 focus:ring-4 focus:ring-red-100 font-medium rounded-lg text-base px-10 py-3 me-2 mb-6 dark:bg-red-400 dark:hover:bg-red-500 focus:outline-none dark:focus:ring-red-600">
                        <p class="text-xl">Supprimer</p>
                      </button>
                    </div>


                    <div class=" place-content-start items-end flex w-2/5 ">
                      <button @click="downloadDocument()" type="button" class="relative top-1 text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:ring-green-100 font-medium rounded-lg text-base px-10 py-3 me-2 mb-6 dark:bg-green-400 dark:hover:bg-green-500 focus:outline-none dark:focus:ring-green-600">
