<template>
  <div class="relative h-[calc(100vh-80px)]">
    <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 drop-document-container max-w-[50%] max-h-[60%] mx-auto text-center border-2 border-[#027BCE] rounded-[10px] p-[7%]">
